...
for Claim in tqdm(Claims, desc="Generating summaries", unit="claim"):
    generated_text = generate_text_chunks(Claim, tokenizer, model)
    generated_texts.append(generated_text)

# Add the summaries to the data frame
df_subset['Claims_chunks_Summary_t5_small'] = generated_texts

# Save the data frame to a new Excel file
output_file = 'Claims_chunks_Summary_t5_small.xlsx'
